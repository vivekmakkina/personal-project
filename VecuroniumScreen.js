    ...
    <View style={styles.container}>
      ...
      <View style={styles.container2}>
        ...
        <View style={styles.subContainer}>
          <Text style={styles.subContainerTitle}>Vecuronium Dose:</Text>
          <View style={styles.subContainerContent}>
            <Text style={styles.subContainerContentText}>0.08 to 0.1 mg/kg</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.outerBox2}>
        <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={true}>
          <Text style={styles.scrollContent}>
            Vecuronium is a neuromuscular blocker used in anesthesia to facilitate endotracheal intubation and maintain muscle relaxation during surgery. The dosage can vary based on patient factors, but the typical intubating dose for vecuronium is:
          </Text>
          <Text style={styles.scrollSubHeading}>Intubating Dose:</Text>
          <Text style={styles.scrollContent}>
            - Dose Range: 0.08 to 0.1 mg/kg administered intravenously (IV).
          </Text>
          ...
          <Text style={styles.scrollContent}>
            - Metabolism: Vecuronium is primarily metabolized by the liver, and its effects may be prolonged in patients with liver dysfunction.
          </Text>
          <Text style={styles.scrollContent}>
            - Side Effects: Possible side effects include hypotension, bradycardia, and allergic reactions.
          </Text>
